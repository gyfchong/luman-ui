...
export const getPatternMetadata = {
  name: 'get_pattern',
  description: 'Get pattern documentation for LLM guidance on accessibility and composition. Returns structured JSON with overview, principles (title, description, code examples), complete example, testing checklist, and WCAG compliance. Available patterns: form-accessibility, form-composition',
